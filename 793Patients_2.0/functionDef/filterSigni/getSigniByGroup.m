function [ signiVector ] = getSigniByGroup( obs, grp, groups )
%GETSIGNIBYGROUP Summary of this function goes here
%   Detailed explanation goes here
if (groups == 2)
    signiVector = IndFeat(obs,grp);
...
if (groups == 3)
    ...
    signiVector = combinedFeatRank123 / 3;
...
if (groups == 4)
    ...
    % normalise the values by taking the average of the values
    signiVector = combinedFeatRank1234 / 6;
